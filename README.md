...
2. Cd into the backend and install dependencies.
...
7. The React frontend has no styling applied. Copy the **.css** files from your
   ...
   **frontend** folder to give your project a unique look.
...
the root of your **frontend** folder when you push to GitHub. This **dist**
folder contains your React code and all necessary dependencies minified and
bundled into a smaller footprint, ready to be served from your Python API.

Begin deployment by running `npm run build` in your **frontend** folder and
